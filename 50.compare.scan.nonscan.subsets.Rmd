---
title: "50.compare.scan.nonscan.subsets"
...
scan.snps <- function(ss.dat, win.size){
...
scan.beta <- scan.snps(ss.dat=ss.dat, win.size=10000)
```
...
#home.allele.diff.boxplot(scan.beta=scan.beta, scan.pval=ss.pval.symb, up.scan.name="swedishgenomes", win.size=10000)
```
...
scan.nonscan.afd.plot.output(n.comp.afd.boxplots=n.comp.afd.boxplots, s.comp.afd.boxplots=s.comp.afd.boxplots, up.scan.name="swedishgenomes", win.size=10000)
```
