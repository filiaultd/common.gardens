...
clim$K.name <- factor(clim$K.name, levels=c("S1","S2","C","B","N1","N2"))
kcol <- brewer.pal(6, "Paired")[c(1,2,5,6,3,4)]
...
map.plot <- plot_grid(map, right.side, labels = c('A', ''), label_size = 12, ncol = 2)

ggsave(map.plot, file="./manuscript.figures/Figure1.jpg", width=9, height=7)
ggsave(map.plot, file="./manuscript.figures/Figure1.jpg", width=7, height=5.5)
```
