...
outfile <- paste("./data/53.data/n.fit2.rot",up.rot,"Rdat", sep=".")
...
scannames <- c("flGER", "flUK", "flSP")


n.fit.rot <- as.list(1:length(scannames))

### 1. Fournier-Level Germany only
up.scan <- 1
