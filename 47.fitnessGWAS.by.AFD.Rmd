...
save(home.beta.l, file="./data/47.data/home.beta.l.Rdat")
```
...
colnames(afb.s) <- gsub("RAM","NM", colnames(afb.s))
colnames(afb.s) <- gsub("ADA","NA", colnames(afb.s))
colnames(afb.s) <- gsub("RAT","SR", colnames(afb.s))
colnames(afb.s) <- gsub("ULL","SU", colnames(afb.s))
...
## save these variables for figure plots
save(afb.n, file="./data/47.data/afb.n.Rdat")
save(afb.s, file="./data/47.data/afb.s.Rdat")
# this is the effect of the home allele (n or s) and the allele frequency infor for each SNP
