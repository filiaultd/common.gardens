...
ben.b <- read.table(file="/groups/nordborg/projects/field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben.blocks.det", header=TRUE, stringsAsFactors=FALSE)
...
ben.b400 <- read.table(file="/groups/nordborg/projects/field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben.400kb.blocks.det", header=TRUE, stringsAsFactors=FALSE)
...
ben.br8 <- read.table(file="/groups/nordborg/projects/field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben.400kb.recomb8.blocks.det", header=TRUE, stringsAsFactors=FALSE)
...
ben.bi9 <- read.table(file="/groups/nordborg/projects/field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben.inform9.blocks.det", header=TRUE, stringsAsFactors=FALSE)
colnames(ben.bi9)[1:2] <- c("Chromosome", "Position")
hist(ben.bi9$NSNPS)
hist(ben.bi9$KB)
genome.plot(ben.bi9,"KB")

ben.bi8 <- read.table(file="/groups/nordborg/projects/field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben.inform8.blocks.det", header=TRUE, stringsAsFactors=FALSE)
colnames(ben.bi8)[1:2] <- c("Chromosome", "Position")
hist(ben.bi8$NSNPS)
hist(ben.bi8$KB)
genome.plot(ben.bi8,"KB")

ben.bi5 <- read.table(file="/groups/nordborg/projects//field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben.inform5.blocks.det", header=TRUE, stringsAsFactors=FALSE)
...
ben.b400.i9 <- read.table(file="/groups/nordborg/projects/field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben400.inform9.blocks.det", header=TRUE, stringsAsFactors=FALSE)
colnames(ben.b400.i9)[1:2] <- c("Chromosome", "Position")
hist(ben.b400.i9$NSNPS)
hist(ben.b400.i9$KB)
genome.plot(ben.b400.i9,"KB")

ben.b400.i8 <- read.table(file="/groups/nordborg/projects/field_experiments/001.common.reference.files/006.field.SNPs.Fernando/haplotype.blocks/plink.ben400.inform8.blocks.det", header=TRUE, stringsAsFactors=FALSE)
