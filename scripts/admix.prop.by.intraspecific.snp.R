## summarize the admixture groups that each SNP occurs in in the 1001g data that is intraspecific
## DLF 11OCT19
...
#####################################################
###### get intraspecific SNPs ############
#####################################################

### polarization happened in /projects/field_experiments/001.common.reference.files/004.genus.vcfs
...
### need 001 cases
intra.snps <- p.snps[p.snps$history=="001",]

admix.prop.intra <- merge(admix.count,intra.snps, by="row.names") 

save(admix.prop.intra, file="./data/admix.prop.intra.Rdat")
